...
def print_result(info_list):
    for total in info_list[::-1]:
        if total:
...
def set_result(info_list, total, d_score, card_no):
    if info_list[total] == 0:
        info_list[total] = [0] * 101
        info_list[total][d_score] = [card_no]
    elif info_list[total][d_score] == 0:
        info_list[total][d_score] = [card_no]
    else:
        info_list[total][d_score].append(card_no)
